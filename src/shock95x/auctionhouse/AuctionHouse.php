...
class AuctionHouse extends PluginBase {
	...
	public function onEnable() : void {
		...
		$resources = ["statements/mysql.sql" => true, "statements/sqlite.sql" => true, "language/Indonesia_By_EdoGaming.yml" => false, "language/ru_RU.yml" => false, "language/de_DE.yml" => false]; //todo
		foreach ($resources as $file => $replace) {
			$this->saveResource($file, $replace);
		}

		$defaultLang = new Config($this->getDataFolder() . "language/Indonesia_By_EdoGaming.yml", Config::YAML);
